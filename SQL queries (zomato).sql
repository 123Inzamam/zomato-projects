...
#----------------------------------------------------question 1 ------------------------------
select
year(datekey) as year1,
month(datekey) as month1,
date_format(datekey,"%M") AS Monthfullname,
quarter(datekey) as quarter1, 
date_format(datekey,"%Y-%m") as yearmonth,
...
#----------------------------------------------------question 2 -----------------------------
select concat("$", 0.012*Average_Cost_for_two) as USD_Dollar from zomata;
